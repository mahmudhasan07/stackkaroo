    ...
    return (
        <section id='chosen'>
            ...
            <div id='chosen4'>
                ...
                <p className='my-8 text-center font-semibold lg:text-xl md:text-xl text-lg tracking-widest'>“Book your consultation now and join the success story of hundreds of our satisfied clients”</p>
