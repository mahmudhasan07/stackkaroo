    ...
    return (
        <section id='work'>
            ...
            <div id='info'>
                ...
                <p id='p1' className='my-8 text-center font-semibold lg:text-xl md:text-xl text-lg tracking-widest'>“Sign up for a personalized quote and see what we can build together”</p>
                ...
                <p id='p3' className='my-8 text-center font-semibold lg:text-xl md:text-xl text-lg tracking-widest'>“Our experts will provide actionable insights to improve your Digital Presence”</p>
            </div>
